    ...
    jQuery(document).ready(function ($) {
        ...
        =========================================*/
			...
			$(".top-benner").on("translate.owl.carousel", function(){
				$(".slider-text h2, .slider-text p").removeClass("animated fadeInUp").css({'opacity':'0'});
				$(".slider-text a").removeClass("animated fadeInDown").css({'opacity':'0'});
			});
			
			$(".top-benner").on("translated.owl.carousel", function(){
				$(".slider-text h2, .slider-text p").addClass("animated fadeInUp").css({'opacity':'0'});
				$(".slider-text a").addClass("animated fadeInDown").css({'opacity':'0'});
			});
